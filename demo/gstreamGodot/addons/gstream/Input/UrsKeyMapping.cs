...
public static class UrsKeyMapping
{
    ...
    /// <summary>
    /// Maps URS gamepad button index (0-15) to Godot JoyButton enum.
    /// Order: A, B, X, Y, LeftShoulder, RightShoulder, LeftTrigger, RightTrigger,
    ...
    public static JoyButton ToGodotJoyButton(int ursButtonIndex)
    {
        return ursButtonIndex switch
        {
            ...
            6 => JoyButton.LeftStick,    // URS LeftTrigger button press
            7 => JoyButton.RightStick,   // URS RightTrigger button press
            8 => JoyButton.Back,
            9 => JoyButton.Start,
